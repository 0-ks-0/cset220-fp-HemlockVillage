...
class RosterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        self::insertData("2024-12-04", Employee::getId(21), Employee::getId(25), Employee::getId(71), Employee::getId(18), Employee::getId(6), Employee::getId(7));
        ...
        self::insertData("2024-12-09", Employee::getId(22), Employee::getId(30), Employee::getId(18), Employee::getId(12), Employee::getId(13), Employee::getId(14));
        self::insertData("2024-12-10", Employee::getId(23), Employee::getId(31), Employee::getId(13), Employee::getId(14), Employee::getId(15), Employee::getId(16));
        self::insertData("2024-12-11", Employee::getId(24), Employee::getId(32), Employee::getId(7),  Employee::getId(17), Employee::getId(8), Employee::getId(16));
        self::insertData("2024-12-12", Employee::getId(21), Employee::getId(33), Employee::getId(13), Employee::getId(18), Employee::getId(12), Employee::getId(15));
        self::insertData("2024-12-13", Employee::getId(22), Employee::getId(34), Employee::getId(12), Employee::getId(13), Employee::getId(12), Employee::getId(8));
    }
